...
@Service
public class ResourcesManagerBean implements ResourceManager {
    ...
    private Path getSourceFile(Path workDir) {
        var codeDir = workDir.getParent();
        var langDir = codeDir.getParent().getFileName().toString();
        CodeLanguage language = CodeLanguage.valueOf(langDir.toUpperCase());
